 ...
 *
 */
BigDecimal convertCurrency(BigDecimal amount, String currencyFrom, String currencyTo, Date date) {
    ...
    def rateFrom = api.vLookup("CurrencyConversion", "InEuros", currencyFrom, month)
    def rateTo = api.vLookup("CurrencyConversion", "InEuros", currencyTo, month)
